...
> Source: https://open.tapd.cn/document/api-doc/API%E6%96%87%E6%A1%A3/api_reference/tcase/add_test_plan.html

-   [SDK 方法名](#sdk-方法名)
    -   [nodeJs](#nodejs)
    -   [python](#python)
    -   [golang](#golang)
-   [在项目下创建测试计划](#在项目下创建测试计划)
...
`curl -u 'api_user:api_password' -d 'name=test&workspace_id=10158231&cus_自定义字段的名称=custom_field_value' 'https://api.tapd.cn/test_plans'`
