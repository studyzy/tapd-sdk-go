...
> Source: https://open.tapd.cn/document/api-doc/API%E6%96%87%E6%A1%A3/api_reference/bug/add_bug.html
...
-   [在项目下创建缺陷](#在项目下创建缺陷)
    ...
    -   [返回结果](#返回结果)
-   [在项目下创建一张带 tapd.cn logo 、优先级为高的缺陷](#在项目下创建一张带-tapd-cn-logo-、优先级为高的缺陷)
    -   [curl 使用 Basic Auth 鉴权调用示例](#curl-使用-basic-auth-鉴权调用示例)
    -   [返回结果](#返回结果)
