...
> Source: https://open.tapd.cn/document/api-doc/API%E6%96%87%E6%A1%A3/api_reference/iteration/get_iteration_custom_fields_settings.html
...
`https://api.tapd.cn/iterations/custom_fields_settings`
...
`curl -u 'api_user:api_password' 'https://api.tapd.cn/iterations/custom_fields_settings?workspace_id=10158231'`
...
```
{
    ...
    "data": [
        {
            "CustomFieldConfig": {
                "id": "1010158231214902319",
                "workspace_id": "10158231",
                "entry_type": "iteration",
                "custom_field": "custom_field_50",
                "type": "text",
                "name": "倒计时",
                "options": null,
                "enabled": "1",
