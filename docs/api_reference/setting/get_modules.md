...
> Source: https://open.tapd.cn/document/api-doc/API%E6%96%87%E6%A1%A3/api_reference/setting/get_modules.html

# 说明

返回符合查询条件的所有模块（分页显示，默认一页30条）
...
`curl -u 'api_user:api_password' 'https://api.tapd.cn/modules?workspace_id=10158231'`

`curl 'Authorization: Bearer ACCESS_TOKEN' 'https://api.tapd.cn/modules?workspace_id=10158231'`
...
```
{
    ...
    "data": [
        {
            "Module": {
                "id": "1010158231007549219",
                "name": "模块1",
                "description": "",
                "owner": "anyechen",
                "created": "2017-06-20 16:49:18"
            }
        }
    ],
    "info": "success"
...
<table><thead><tr><th style="text-align:center;">字段</th><th style="text-align:center;">说明</th></tr></thead><tbody><tr><td style="text-align:center;">id</td><td style="text-align:center;">id</td></tr><tr><td style="text-align:center;">name</td><td style="text-align:center;">标题</td></tr><tr><td style="text-align:center;">description</td><td style="text-align:center;">详细描述</td></tr><tr><td style="text-align:center;">owner</td><td style="text-align:center;">负责人</td></tr><tr><td style="text-align:center;">created</td><td style="text-align:center;">创建时间</td></tr><tr><td style="text-align:center;">workspace_id</td><td style="text-align:center;">项目ID</td></tr></tbody></table>
