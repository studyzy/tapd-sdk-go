...
> Source: https://open.tapd.cn/document/api-doc/API%E6%96%87%E6%A1%A3/api_reference/setting/get_baselines_count.html

-   [SDK 方法名](#sdk-方法名)
    -   [nodeJs](#nodejs)
    -   [python](#python)
    -   [golang](#golang)
-   [获取项目下基线的数量](#获取项目下基线的数量)
...
`https://api.tapd.cn/baselines/count`
...
`curl -u 'api_user:api_password' 'https://api.tapd.cn/baselines/count?workspace_id=755'`

`curl 'https://api.tapd.cn/baselines/count?workspace_id=755&access_token=ACCESS_TOKEN'`
