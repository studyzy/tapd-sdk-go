...
> Source: https://open.tapd.cn/document/api-doc/API%E6%96%87%E6%A1%A3/api_reference/testx/plan/get_plan.html

获取计划详情

# url

`https://api.tapd.cn/api/testx/plan/v1/namespaces/{namespace}/plans/{plan_uid}`
...
| WithStatistic | 否 | bool | 是否获取统计信息 |
| WithDetail | 否 | string | 获取详情级别 |
