...
> Source: https://open.tapd.cn/document/api-doc/API%E6%96%87%E6%A1%A3/api_reference/testx/case/batch_create_case.html
...
| TargetFolderUid | 是 | string | 目标目录 |
| Folder | 否 | repeated Folder | 目录信息 |
| Cases | 否 | repeated Case | 用例信息 |
